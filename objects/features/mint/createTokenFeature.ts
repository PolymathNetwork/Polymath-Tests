...
@injectable export class CreateTokenFeature extends AbstractFeature implements TokenInfoModel {
    ...
    @radioBox(By.xpath('.//*[@class="bx--radio-button-group"]'), {
        './/*[@for="isDivisible-0" or @for="isDivisible-divisible"]': DivisibleIndivisible.Divisble,
        './/*[@for="isDivisible-1" or @for="isDivisible-indivisible"]': DivisibleIndivisible.Indivisible
    }, {
    ...
    @order(2) @singleCheckbox(By.xpath('.//*[@for="investors-number-toggle" or (@for="limitInvestors" and @class="bx--toggle__label")]'), { checkedSelector: By.xpath('//*[@id="investorsNumber"]') }) public allowMaxInvestors: boolean;
